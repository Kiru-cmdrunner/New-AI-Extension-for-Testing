    ...
    it('handles heavy DOM mutations (200 capped)', () => {
      ...
      const evidence = makeValidEvidence({
        applicationEvidence: {
          ...
          coarseMode: true,
          newSurfaces: [
            { path: 'div.cart-drawer', tagName: 'div', ariaRole: 'dialog', accessibleName: 'Shopping Cart', shadowContext: null, descendantCount: 50, relativeTime: 500, batchIndex: 10, kind: 'added' as const },
          ],
          removedSurfaces: [],
          visibilityChanges: [
        ...
        makeValidInteraction({
          ...
          behavioralEvidence: makeValidEvidence({
            ...
            targetEvidence: {
              ...
              before: { value: '', checked: null, className: 'oxd-input', disabled: false, ariaExpanded: null, ariaChecked: null, ariaPressed: null, textContent: null, childCount: 0, scrollTop: null, scrollLeft: null, selectedValues: null, controlledValue: null, capturedAt: 500 },
              after: { value: 'Admin', checked: null, className: 'oxd-input', disabled: false, ariaExpanded: null, ariaChecked: null, ariaPressed: null, textContent: null, childCount: 0, scrollTop: null, scrollLeft: null, selectedValues: null, controlledValue: null, capturedAt: 1000 },
              focusMovement: null,
            },
            applicationEvidence: {
              domChanges: [],
        ...
        makeValidInteraction({
          ...
          behavioralEvidence: makeValidEvidence({
            ...
            targetEvidence: {
              ...
              before: { value: '', checked: null, className: 'oxd-input', disabled: false, ariaExpanded: null, ariaChecked: null, ariaPressed: null, textContent: null, childCount: 0, scrollTop: null, scrollLeft: null, selectedValues: null, controlledValue: null, capturedAt: 1500 },
              after: { value: '••••••••', checked: null, className: 'oxd-input', disabled: false, ariaExpanded: null, ariaChecked: null, ariaPressed: null, textContent: null, childCount: 0, scrollTop: null, scrollLeft: null, selectedValues: null, controlledValue: null, capturedAt: 2000 },
              focusMovement: null,
            },
            applicationEvidence: {
              domChanges: [],
