...
/** How meaningful an interaction is for the workflow. Determined by the classifier. */
export enum RelevanceLevel {
  /** Purposeful action that should become a test step. Produced an observable state change. */
  DELIBERATE = 'deliberate',
  /** Contextually meaningful but not a standalone action (e.g., lifecycle mechanics inside a component). */
  SUPPORTING = 'supporting',
  /** No observable outcome — incidental interaction, filtered from the pipeline. */
  NOISE = 'noise',
}

/** What operation a transition represents. */
...
/** Type of evidence signal confirming a state transition. */
export enum TransitionEvidenceType {
...
/** How a cascade effect manifests on the affected element. */
